...
// ════════════════════════════ FORMATTERS ═════════════════════════════
export const fmt = (n) => n != null && n !== 0 ? new Intl.NumberFormat('en-SG', { style: 'currency', currency: 'SGD', minimumFractionDigits: 2 }).format(n) : '\u2014';
export const fmtDate = (d) => d && d !== 'None' ? new Date(d).toLocaleDateString('en-SG', { day: '2-digit', month: 'short', year: 'numeric' }) : '\u2014';
...
export const toggleSort = (setter, key) => setter(s => ({ key, dir: s.key === key && s.dir === 'asc' ? 'desc' : 'asc' }));

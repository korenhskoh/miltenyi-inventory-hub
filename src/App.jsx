...
import { STATUS_CFG, Badge, ArrivalBadge, Pill, Toggle, Toast, BatchBar, BatchBtn, SortTh, ExportDropdown, SelBox, QRCodeCanvas } from './components/ui.jsx';
...
{/* ALL ORDERS */}
{page==='allorders'&&<AllOrdersPage {...{
  orders, bulkGroups, catalogLookup, currentUser,
  allOrdersCombined, allOrdersSort, setAllOrdersSort,
  allOrdersTypeFilter, setAllOrdersTypeFilter,
  allOrdersMonth, setAllOrdersMonth, allOrdersMonths,
  allOrdersStatus, setAllOrdersStatus,
  allOrdersUserFilter, setAllOrdersUserFilter, allOrdersUsers,
  expandedAllMonth, setExpandedAllMonth,
  expandedAllBulkGroup, setExpandedAllBulkGroup,
  openOrderInNewTab
}} />}
...
{/* FORECASTING */}
{page==='forecasting'&&hasPermission('analytics')&&<ForecastingPage {...{
...
{/* STOCK CHECK */}
{page==='stockcheck'&&<StockCheckPage {...{
  ...
  currentUser, addStockCheck, notify, dbSync, api,
  batchDeleteStockChecks, toggleSel, toggleAll, hasPermission
}} />}

{/* PART ARRIVAL CHECK */}
{page==='delivery'&&<DeliveryPage {...{
  orders, bulkGroups, setBulkGroups,
  arrivalMonthFilter, setArrivalMonthFilter,
  arrivalOrderByFilter, setArrivalOrderByFilter, arrivalOrderByUsers,
  selectedBulkForArrival, setSelectedBulkForArrival,
  arrivalItems, setArrivalItems,
  pendingArrival, setPendingArrival,
  arrivalSelected, setArrivalSelected,
  arrivalSort, setArrivalSort,
  arrivalStatusFilter, setArrivalStatusFilter,
  arrivalTypeFilter, setArrivalTypeFilter,
  waConnected, waMessageTemplates, waNotifyRules,
  currentUser, users, WA_API_URL,
  confirmArrival, batchConfirmArrival,
  notify, addNotifEntry, dbSync, api, setPage
}} />}
...
{/* AI BOT ADMIN */}
{page==='aibot'&&hasPermission('aiBot')&&<AiBotPage {...{
  aiAdminTab, setAiAdminTab, aiKnowledgeBase, setAiKnowledgeBase,
  aiBotConfig, setAiBotConfig, aiConversationLogs, waAutoReply,
  handleFileUpload, notify, dbSync, api
}} />}

{page==='settings'&&hasPermission('settings')&&<SettingsPage {...{
  customLogo, setCustomLogo, emailConfig, setEmailConfig, priceConfig, setPriceConfig,
  waConnected, waMessageTemplates, setWaMessageTemplates, waAllowedSenders, setWaAllowedSenders,
  partsCatalog, setPartsCatalog, showCatalogMapper, setShowCatalogMapper, catalogColumnMap, setCatalogColumnMap,
  catalogMapperData, setCatalogMapperData, editingTemplate, setEditingTemplate, emailTemplates, setEmailTemplates,
  pendingApprovals, selApprovals, setSelApprovals, orders, setOrders, bulkGroups, setBulkGroups,
  notifLog, setNotifLog, setPendingApprovals, currentUser, users,
  hasPermission, notify, dbSync, handleApprovalAction, batchApprovalAction,
  toggleSel, toggleAll, handleHistoryImport, setPage, waNotifyRules, scheduledNotifs, LS_KEYS, api
}} />}
